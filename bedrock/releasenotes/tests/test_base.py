...
RELEASES_PATH = str(Path(__file__).parent / 'releases')
...
class TestRNAViews(TestCase):
    def setUp(self):
        ...
        self.orig_releases_path = Release.RELEASES_PATH
        Release.RELEASES_PATH = RELEASES_PATH

    def tearDown(self):
        self.render_patch.stop()
        Release.RELEASES_PATH = self.orig_releases_path
